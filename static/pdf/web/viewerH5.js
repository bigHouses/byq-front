...
/******/ (function(modules) { // webpackBootstrap
  ...
  /******/ ([
    ...
    /***/ (function(module, exports, __webpack_require__) {
      ...
      var DISABLE_AUTO_FETCH_LOADING_BAR_TIMEOUT = 10000;
      ...
      var PDFPresentationMode = function () {
        ...
        _createClass(PDFPresentationMode, [{
          ...
          value: function _goToPreviousPage() {
            //console.info("_goToPreviousPage.。。。")
          ...
          value: function _notifyStateChange() {
            //console.info("_notifyStateChange.。。。")
          ...
          value: function _setSwitchInProgress() {
            //console.info("_setSwitchInProgress.。。。")
            var _this2 = this;
          ...
          value: function _resetSwitchInProgress() {
            //console.info("_resetSwitchInProgress.。。。")
            if (this.switchInProgress) {
              clearTimeout(this.switchInProgress);
          ...
          value: function _contextMenu() {
            //console.info("_contextMenu.。。。")
            this.contextMenuOpen = true;
          }
        }, {
          key: '_showControls',
          value: function _showControls() {
            //console.info("_showControls.。。。")
            var _this5 = this;
          ...
          value: function _resetMouseScrollState() {
            //console.info("_resetMouseScrollState.。。。")
            this.mouseScrollTimeStamp = 0;
            this.mouseScrollDelta = 0;
          }
        }, {
          ...
          value: function _addWindowListeners() {
            //console.info("_addWindowListeners.。。。")
          ...
          value: function _removeWindowListeners() {
            //console.info("_removeWindowListeners.。。。")
          ...
          value: function _fullscreenChange() {
            //console.info("_fullscreenChange.。。。")
          ...
          value: function _addFullscreenChangeListeners() {
            //console.info("_addFullscreenChangeListeners.。。。")
          ...
          value: function _removeFullscreenChangeListeners() {
            //console.info("_removeFullscreenChangeListeners.。。。")
        ...
        _createClass(PDFThumbnailViewer, [{
          ...
          value: function setDocument(pdfDocument) {
            ...
            pdfDocument.getPage(1).then(function (firstPage) {
              ...
              var viewport = firstPage.getViewport(1);
      ...
      var BaseViewer = function () {
        ...
        _createClass(BaseViewer, [{
          ...
          value: function getPageView(index) {
            //console.info("getPageView......")
            return this._pages[index];
          }
        }, {
          key: '_setCurrentPageNumber',
          value: function _setCurrentPageNumber(val) {
            //console.info("_setCurrentPageNumber......")
          ...
          value: function _setScaleDispatchEvent(newScale, newValue) {
            //console.info("_setScaleDispatchEvent......")
          ...
          value: function _setScaleUpdatePages(newScale, newValue) {
            //console.info("_setScaleUpdatePages......")
          ...
          value: function _setScale(value) {
            ////console.info("_setScale......" + value)
            var noScroll = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
            //parseFloat(value);
            var scale = 0.5//移动端，默认0.5
            if (scale > 0) {
          ...
          value: function _resetCurrentPageView() {
            //console.info("_resetCurrentPageView......")
            if (this.isInPresentationMode) {
          ...
          value: function scrollPageIntoView(params) {
            //console.info("scrollPageIntoView......")
          ...
          value: function _ensurePdfPageLoaded(pageView) {
            //console.info("_ensurePdfPageLoaded......")
            var _this2 = this;
          ...
          value: function getPageTextContent(pageIndex) {
            //console.info("getPageTextContent......")
          ...
          value: function createTextLayerBuilder(textLayerDiv, pageIndex, viewport) {
            //console.info("createTextLayerBuilder......")
          ...
          value: function createAnnotationLayerBuilder(pageDiv, pdfPage) {
            //console.info("createAnnotationLayerBuilder......")
